...
Once in the game you should calibrate [VRIK](https://www.nexusmods.com/skyrimspecialedition/mods/23416) by using the `VRIK Calibration Power` while standing on a flat surface ingame. Then be sure to check the `Mod Configuration` settings in the game and set stuff up how you want it. These mods are probably something you want to check (see their mod pages for more info):
